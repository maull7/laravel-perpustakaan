                        ...
                        <form action="{{ route('book.update', $book->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="judul" class="form-control" id="Books"
                                    placeholder="Masukan nama produk" value="{{ old('judul', $book->judul) }}">
                                @error('judul')
                            ...
                            <div class="mb-3">
                                ...
                                <input type="file" name="image" class="form-control" id="Type"
                                    placeholder="Masukan tipe produk" value="{{ old('image', $book->image) }}">
                                @error('image')
                                    <small class="text-danger">{{ $message }}</small>
                                @enderror
                            </div>
                            <div class="mb-3">
                                ...
                                <input type="text" name="pengarang" class="form-control" id="Price"
                                    placeholder="Masukan harga produk" value="{{ old('pengarang', $book->pengarang) }}">
                                @error('pengarang')
                                    <small class="text-danger">{{ $message }}</small>
                                @enderror
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="penerbit" class="form-control" id="Price"
                                    placeholder="Masukan harga produk" value="{{ old('penerbit', $book->penerbit) }}">
                                @error('penerbit')
                                    <small class="text-danger">{{ $message }}</small>
                                @enderror
                            </div>
                            <div class="mb-3">
                                ...
                                <input type="number" name="stok" class="form-control" id="Quantity"
                                    placeholder="Masukan stok produk" value="{{ old('stok', $book->stok) }}">
                                @error('stok')
                                    <small class="text-danger">{{ $message }}</small>
                                @enderror
                            </div>
